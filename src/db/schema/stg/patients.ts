...
export const patientsStg = createTable(
  "stg.patients",
  {
    ...
    postalAddressDeprivationDecile: integer(
  ...
  (table) => [
    ...
    uniqueIndex("patients_stg_natural_key_idx").on(
      table.patientId,
      table.practiceId,
      table.perOrgId
    ),
...
export const fkPatientsStgLoadRunFile = foreignKey({
  columns: [patientsStg.loadRunFileId],
  foreignColumns: [loadRunFiles.loadRunFileId],
  name: "fk_patients_stg_load_run_file",
});
