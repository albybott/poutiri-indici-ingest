...
export const nextofkinRaw = createTable("raw.next_of_kin", {
  // Source columns as text (all fields from next-of-kin extract)
  nextToKinId: text("next_to_kin_id"),
...
export const fknextofkinRawLoadRunFile = foreignKey({
  columns: [nextofkinRaw.loadRunFileId],
  foreignColumns: [loadRunFiles.loadRunFileId],
  name: "fk_next-of-kin_load_run_file",
});
