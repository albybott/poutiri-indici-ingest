...
export const invoiceDetailStg = createTable("stg.invoice_detail_stg", {
...
export const invoiceDetailStgUniqueConstraint = uniqueIndex(
  "invoice_detail_stg_natural_key_idx"
).on(
