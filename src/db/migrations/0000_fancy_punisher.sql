...
CREATE TABLE "stg"."diagnoses" (
	...
	"concept_id" text,
	"load_run_file_id" integer NOT NULL,
	"loaded_date_time" timestamp with time zone NOT NULL,
...
CREATE UNIQUE INDEX "measurements_stg_natural_key_idx" ON "stg"."measurements" USING btree ("screaning_id","practice_id","per_org_id");--> statement-breakpoint
