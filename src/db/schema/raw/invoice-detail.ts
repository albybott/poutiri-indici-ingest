...
export const invoicedetailRaw = createTable("raw.invoice_detail", {
  // Source columns as text (all fields from invoice-detail extract)
...
export const fkinvoicedetailRawLoadRunFile = foreignKey({
  columns: [invoicedetailRaw.loadRunFileId],
  foreignColumns: [loadRunFiles.loadRunFileId],
  name: "fk_invoice-detail_load_run_file",
});
