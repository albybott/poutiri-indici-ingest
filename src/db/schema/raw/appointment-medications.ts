...
export const appointmentmedicationsRaw = createTable("raw.appointment_medications", {
  // Source columns as text (all fields from appointment-medications extract)
...
export const fkappointmentmedicationsRawLoadRunFile = foreignKey({
  columns: [appointmentmedicationsRaw.loadRunFileId],
  foreignColumns: [loadRunFiles.loadRunFileId],
  name: "fk_appointment-medications_load_run_file",
});
